      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <h2 style={{ fontSize: "clamp(28px,5vw,46px)", fontWeight: 900, color: "#1D1D1F", letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: 12 }}>
            ₪700 בחודש = <span style={{ color: "#0066CC" }}>₪8,400 נטו בשנה</span>
          </h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16, marginBottom: 48 }}>
          {[
            ...
            { emoji: "📱", label: "חשמל ומובייל", value: "₪700", sub: "חיסכון על אייפון 16 Pro" },
            { emoji: "✈️", label: "נופש וחופשות", value: "50%", sub: "הנחה על חבילות נסיעה" },
          ].map((tile, i) => (
            <motion.div
              key={i}
        ...
        >
          <p style={{ fontSize: "clamp(22px,4vw,32px)", fontWeight: 900, color: "#fff", marginBottom: 12, letterSpacing: "-0.02em" }}>
            100% ערך לעובד. <span style={{ color: "#34C759" }}>0₪ עלות למעסיק.</span>
          </p>

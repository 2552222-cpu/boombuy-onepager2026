...
const OFFERS = [
  ...
  { id: "culture",  cat: "תרבות ופנאי",        brand: "קזבלן",          title: "קזבלן · הצגת השנה",             priceOld: "350",   priceNew: "77",    saving: "273",   labelOld: "מחיר שוק",    desc: "תערוכות, הופעות והצגות בארץ ובחול במחירים נגישים.", img: "https://media.base44.com/images/public/69bc4105141d932b80ba9f27/3c42d518b_-2026-03-22T140039783.png" },
  { id: "vacation", cat: "נופש וחופשות",       brand: "מלונות בראון",   title: "מלונות בראון · פרימיום",         priceOld: "1,790", priceNew: "899",   saving: "891",   labelOld: "מחיר שוק",    desc: "חופשות בארץ ובחול במחירים בלעדיים - עד 50% הנחה.", img: "https://media.base44.com/images/public/69bc4105141d932b80ba9f27/7cc501b0f_-2026-03-22T133529822.png" },
  ...
  return (
    <section id="offers-slider" style={{ background: "#FFFFFF", padding: "80px 0", direction: "rtl", overflowX: "hidden" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center", padding: "0 16px" }}>
        ...
        <p style={{ color: "#86868B", marginBottom: "52px", fontSize: "clamp(15px, 2vw, 18px)", fontWeight: 400 }}>דוגמאות להטבות אמיתיות שמגדילות את הנטו</p>
          ...
          {OFFERS.map((offer, i) => {
            ...
            return (
              <motion.div key={offer.id}
                onClick={() => i === index ? openModal(offer.id) : setIndex(i)}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div
              ...
              <div style={{ flex: isMobile ? "0 0 50%" : "1.3", background: "#fff", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
                ...
                <button onClick={() => closeModal()} style={{ position: "absolute", top: 20, left: 20, background: "rgba(0,0,0,0.2)", border: "none", width: "40px", height: "40px", borderRadius: "50%", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 20 }}>
                  <X size={20} color="#fff" />
                </button>

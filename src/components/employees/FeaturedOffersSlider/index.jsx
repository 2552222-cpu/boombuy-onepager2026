...
// ─── OFFERS DATA (6 items, no duplicates) ────────────────────────────────────
const OFFERS = [
  {
    id: "samba",
    num: 1,
  ...
  },
  {
    ...
    cat: "כל בוקר הטבה חדשה",
    brand: "Yoko",
    productName: "כסא גיימינג",
    labelOld: "מחיר שוק",
    priceOld: "1,090",
    priceNew: "120",
    saving: "970",
    desc: "כסא גיימינג מקצועי יוקו — ריפוד איכותי, תמיכה לומברית, משענות יד מתכווננות, בהנחה חריגה.",
  ...
  },
  {
    ...
    cat: "כל בוקר הטבה חדשה",
    brand: "Swiss",
    productName: "מזוודות סוויס",
    labelOld: "מחיר שוק",
    priceOld: "699",
    priceNew: "199",
    saving: "500",
    desc: "סט 3 מזוודות קשיחות Swiss בעיצוב מודרני — קל משקל, מנעול TSA, גלגלים שקטים.",
  ...
  },
  {
    ...
    priceNew: "139",
    saving: "310",
    desc: "שמיכת מזגן קיצית מפנקת של כיתן — 100% כותנה, נושמת, קלה ורכה.",
  ...
  },
  {
    ...
    cat: "כל בוקר הטבה חדשה",
    brand: "Golf & Co",
    productName: "סט מצעי ג'רסי",
    labelOld: "מחיר ברשת",
    priceOld: "749",
    priceNew: "269",
    saving: "480",
    desc: "סט מצעי ג'רסי 100% כותנה סרוקה של Golf & Co — רך במיוחד, אחיד בצבע, נמתח ונוח.",

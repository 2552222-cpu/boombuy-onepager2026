...
const OFFERS = [
  ...
  { id: "samba", cat: "כל בוקר הטבה חדשה", brand: "Adidas Samba", title: "כל בוקר הטבה, אטרקציה או חוויה חדשה", priceOld: "₪499", priceNew: "₪299", saving: "₪200", labelOld: "מחיר באדידס", desc: "הדגם המבוקש בעולם במחיר בלעדי לעובדים לבוקר זה בלבד.", img: "https://media.base44.com/images/public/69bc4105141d932b80ba9f27/b7485969d_-2026-02-18T150744909.png" },
];

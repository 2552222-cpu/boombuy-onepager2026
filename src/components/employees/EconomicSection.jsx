...
const cards = [
  {
    ...
    body: "מתנות חג ופעילויות רווחה הן חשובות, אבל ברוב הארגונים הן לא נוגעות מספיק בהוצאות שחוזרות כל חודש.",
  },
  {
    icon: Wallet,
    accent: "#FF9500",
    title: "מה העובדים באמת צריכים",
    body: "יותר ערך בסופר, פארם, חשמל, חופשות ומותגים - לא רק בחג, אלא לאורך השנה.",
  },
  {
    icon: Layers,
    accent: "#34C759",
    title: "מה בום ביי מוסיפה",
    body: "בנוסף למה שכבר קיים, בום ביי מוסיפה הטבות וערך כלכלי מתמשך שיכול לעזור לעובדים להגדיל את הנטו.",
  },
];
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        >
          <h2 style={{ fontSize: "clamp(22px,4vw,36px)", fontWeight: 900, color: "#1D1D1F", letterSpacing: "-0.03em", lineHeight: 1.2, marginBottom: 10 }}>
            בנוסף למתנות החג, העובדים יכולים לקבל ערך כלכלי מתמשך לאורך כל השנה.
          </h2>
          <p style={{ fontSize: "clamp(16px,2vw,19px)", fontWeight: 600, color: "#0066CC", maxWidth: 540, margin: "0 auto 8px", lineHeight: 1.5 }}>
            הטבות שיכולות לעזור לעובדים להגדיל את הנטו, בלי להחליף את מה שכבר קיים בארגון.
          </p>

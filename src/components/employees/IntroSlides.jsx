...
const SLIDES = [
  {
    lines: ["מה אם העבודה שלך", "הייתה שווה לך הרבה יותר?"],
  ...
  {
    lines: ["8% הנחה קבועה בסופר", "ומחירי יבואן על מוצרים", "שאתם בכל מקרה צורכים"],
  ...
  {
    lines: ["וכל זה בלי שהמעסיק", "יוסיף שקל לתקציב", "שהוא ממילא מוציא"],
    size: "clamp(22px, 6vw, 36px)",
    weight: 700,
    color: "#1D1D1F",
    highlights: ["ממילא"],

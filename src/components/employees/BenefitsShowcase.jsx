...
const categories = [
  ...
  },
  {
    ...
    emoji: "🎭",
    title: "תרבות ופנאי",
    description: "הופעות למבוגרים בארץ ובחו\"ל. משחקי ספורט בארץ ובחו\"ל. הצגות לילדים, תערוכות ואטרקציות.",
    sub: "הופעות · משחקי ספורט · הצגות לילדים · תערוכות",
    tag: "הנחת עובד",
    tagBg: "bg-rose-500",
  ...
  },
  {
    id: "fairs",
    emoji: "🏪",
    title: "ירידים ואירועי Pop-Up",
    description: "יריד Back to School, רכב ודירה — בהטבות מיוחדות ומחירים נמוכים במיוחד.",
    sub: "Back to School · רכב ודירה · אירועים תקופתיים מיוחדים",
    tag: "אירועים מיוחדים",
    tagBg: "bg-teal-600",

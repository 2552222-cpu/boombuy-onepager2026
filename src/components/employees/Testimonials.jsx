...
const testimonials = [
  ...
  },
  {
    name: "תהילה מליחי",
    org: "מקס",
    text: <>ההטבות שלכם באמת שוות. קניתי אלו יוגה וחסכתי בקנייה אחת <ILS value="1,000" />שקל.</>,
  },
  {
    name: "מיכל ברגר",
    org: "בנק ישראל",
    text: "ציפינו לעוד מועדון, ובפועל קיבלנו הטבות שבאמת מרגישים. אחלה הטבות, תמשיכו ככה.",
  },
  {
    name: "דן לוי",
    org: "SAP",

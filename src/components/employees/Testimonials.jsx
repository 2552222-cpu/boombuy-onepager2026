...
const testimonials = [
  ...
  },
  {
    ...
    logoHeight: 44,
    text: "Boombuy – היא שותפה אמיתית לדרך. השירות האנושי, החום האישי והמקצועיות מורגשים בכל פרס. אתר ההטבות מגוון, משתלם ואטרקטיבי, והעובדים שלנו נהנים ממנו מאוד!",
  },
  {
    name: "יקירה שינדר",
    ...
    logoHeight: 44,
    text: "חברת boombuy דואגת כל יום להטבה יומית. דבר שיצר בז חיובי ומדהים אצל העובדים. השירות והמקצועות מעל הכל!",
  },
];

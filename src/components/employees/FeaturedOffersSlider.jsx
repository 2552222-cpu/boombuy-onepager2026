...
const OFFERS = [
  ...
  { id: "vacation", cat: "חופשות", title: "מלונות בראון ונופש יוקרה", priceOld: "₪1,790", priceNew: "₪899", accent: "#FF9500", img: "https://media.base44.com/images/public/69bc4105141d932b80ba9f27/2c9f901f1_-2026-03-22T133529822.png" },
            ...
            <motion.div layoutId={selectedId} style={modalContainerStyle}>
              ...
              <div style={modalContentStack}>
                ...
                <div style={modalTextPane}>
                  ...
                  <p style={modalDesc}>{DESCS[selectedId]}</p>
                  ...
                  <button style={finalCta} onClick={() => { setSelectedId(null); setTimeout(() => document.getElementById("survey-section")?.scrollIntoView({ behavior: "smooth" }), 300); }}>
...
const tagStyle = { position: "absolute", top: "16px", right: "16px", background: "rgba(0,0,0,0.6)", backdropFilter: "blur(6px)", color: "#fff", padding: "4px 12px", borderRadius: "100px", fontSize: "11px", fontWeight: 700, zIndex: 5, fontFamily: "var(--font-heebo)" };
const titleInCardStyle = { position: "absolute", bottom: "20px", width: "100%", textAlign: "center", color: "#fff", fontWeight: 800, fontSize: "15px", textShadow: "0 2px 8px rgba(0,0,0,0.5)", fontFamily: "var(--font-heebo)" };
...
const modalTextPane = { flex: 1.2, padding: "30px", background: "#fff", textAlign: "right", direction: "rtl", display: "flex", flexDirection: "column", justifyContent: "flex-end" };
const modalTagStyle = { color: "#86868B", fontWeight: 700, fontSize: "12px", marginBottom: "8px", textTransform: "uppercase", fontFamily: "var(--font-heebo)" };
...
const oldPrice = { fontSize: "15px", color: "#86868B", textDecoration: "line-through", fontFamily: "var(--font-heebo)" };
const newPrice = { fontSize: "26px", fontWeight: 900, color: "#0066CC", fontFamily: "var(--font-heebo)" };
